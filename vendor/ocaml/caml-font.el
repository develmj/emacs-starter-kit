...
;       (not (memq 'font-lock-type-face (face-list))))
 (t
  ...
  (set-face-foreground 'caml-font-lock-comment-face "#999")
  ...
  (set-face-foreground 'caml-font-lock-function-name-face "#e9c062")
  (make-face 'caml-font-lock-keyword-face)
  (set-face-foreground 'caml-font-lock-keyword-face "lightsalmon")
  (caml-make-face-bold 'caml-font-lock-keyword-face)
  (make-face 'caml-font-lock-variable-name-face)
  (set-face-foreground 'caml-font-lock-variable-name-face "red")
  (make-face 'caml-font-lock-type-face)
  (set-face-foreground 'caml-font-lock-type-face "brown")
